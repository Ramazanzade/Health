    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff' }}>
      ...
      <View style={doctorcss.view14}>
        <View style={doctorcss.view15}>
          <Text style={doctorcss.text15}>Subtotal</Text>
          <Text style={doctorcss.text16}> ${totalPrice}</Text>
        </View>
        <View style={doctorcss.view15}>
          <Text style={doctorcss.text15}>Taxes</Text>
      ...
      <View style={doctorcss.view9}>
        <TouchableOpacity style={[doctorcss.touc1, { backgroundColor: '#ffffff', marginTop: '0%', width:90 }]}>
